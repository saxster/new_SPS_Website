...
class GeminiAgent:
    def __init__(self):
        ...
        if not self.api_key:
            logger.warning("no_api_key", hint="GeminiAgent initialized without API key. Generation will fail.")
    ...
    def generate(self, prompt: str, temperature: float = None, model: str = None) -> str:
